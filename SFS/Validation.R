...
url <- 'http://esoil.io/SensorFederationWebAPI/SensorAPI/getSensorDataStreams?siteid=VicAg_LakeBolac&sensortype=Rainfall&startdate=2016-01-01T00%3A00%3A00&enddate=2019-01-01T00%3A00%3A00&aggperiod=days'
...
saveRDS(bolacRain,  paste0(dataRoot, '/Validation/bolacRain.rds'))

url <- 'http://esoil.io/SensorFederationWebAPI/SensorAPI/getSensorDataStreams?siteid=VicAg_LakeBolac&sensortype=Soil-Moisture&startdate=2016-01-01T00%3A00%3A00&enddate=2019-01-01T00%3A00%3A00&aggperiod=days'
...
plot(bsm)
saveRDS(bsm,  paste0(dataRoot, '/Validation/bolacSM30.rds'))
